...
export default function HeroSection() {
    const [form, setForm] = useState({name: "", machineType: "",  email: "", phone: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                setStatus("success");
                setForm({ machineType: "", name: "", phone: "", email: "" });
    ...
    return (
        <section className="hero-section" id="formularz">
            <div
                className="hero-bg"
                style={{ backgroundImage: `url('http://localhost:4000/images/bg.jpg')` }}
            />
                        ...
                        {status === "success" ? (
                            ...
                            <form className="hero-form" onSubmit={handleSubmit}>
                                ...
                                <div className="form-group">
                                 ...
                                 <div className="form-group">
                                    <label className="form-label">Maszyna</label>
                                    <input
                                        type="text"
                                        name="machineType"
                                        placeholder="Koparka"
