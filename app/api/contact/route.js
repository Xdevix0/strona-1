...
export async function POST(request) {
  ...
  const { name, phone, email, machineType } = body;
    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%">
          ...
          <tr><td style="padding:8px;border:1px solid #ddd"><b>Maszyna</b></td><td style="padding:8px;border:1px solid #ddd">${machineType}</td></tr>
